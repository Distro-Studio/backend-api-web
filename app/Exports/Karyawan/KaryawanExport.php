...
class KaryawanExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($karyawan): array
    {
        ...
        return [
            ...
            $formatDate($karyawan->tgl_masuk) ?? 'N/A',
            ...
            $formatDate($karyawan->tgl_keluar) ?? 'N/A',
            $karyawan->no_kk ?? 'N/A',
            $karyawan->alamat ?? 'N/A',
            ...
            $formatDate($karyawan->tgl_diangkat) ?? 'N/A',
            $masaKerja,
            $karyawan->npwp ?? 'N/A',
            $karyawan->jenis_kelamin ? 'Laki-laki' : 'Perempuan',
            optional($karyawan->kategori_agamas)->label,
            optional($karyawan->kategori_darahs)->label,
            $karyawan->tinggi_badan ?? 'N/A',
            $karyawan->berat_badan ?? 'N/A',
            $karyawan->bmi_value ?? 'N/A',
            $karyawan->bmi_ket ?? 'N/A',
            $karyawan->riwayat_penyakit ?? 'N/A',
            $karyawan->no_ijazah ?? 'N/A',
            $karyawan->tahun_lulus ?? 'N/A',
            $karyawan->no_str ?? 'N/A',
            $formatDate($karyawan->created_str) ?? 'N/A',
            Carbon::parse($karyawan->masa_berlaku_str)->format('d-m-Y') ?? 'N/A',
            $karyawan->no_sip ?? 'N/A',
            $formatDate($karyawan->created_sip) ?? 'N/A',
            Carbon::parse($karyawan->masa_berlaku_sip)->format('d-m-Y') ?? 'N/A',
            $formatDate($karyawan->tgl_berakhir_pks) ?? 'N/A',
            $this->formatDuration($karyawan->masa_diklat) ?? 'N/A',
