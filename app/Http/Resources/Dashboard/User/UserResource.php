    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'data'  => [
                ...
                'foto_profil' => $this->foto_profiles ? [
                    'id' => $this->foto_profiles->id,
                    'user_id' => $this->foto_profiles->user_id,
                    'file_id' => $this->foto_profiles->file_id,
                    'nama' => $this->foto_profiles->nama,
                    'nama_file' => $this->foto_profiles->nama_file,
                    'path' => env('STORAGE_SERVER_DOMAIN') . $this->foto_profiles->path,
                    'ext' => $this->foto_profiles->ext,
                    'size' => $this->foto_profiles->size,
                ] : null,
