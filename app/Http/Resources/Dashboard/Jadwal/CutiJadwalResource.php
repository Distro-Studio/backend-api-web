        ...
        return $collection->transform(function ($cuti_jadwal) {
            return [
                ...
                'user' => [
                    ...
                    'foto_profil' => $cuti_jadwal->users->foto_profiles ? [
                        'id' => $cuti_jadwal->users->foto_profiles->id,
                        'user_id' => $cuti_jadwal->users->foto_profiles->user_id,
                        'file_id' => $cuti_jadwal->users->foto_profiles->file_id,
                        'nama' => $cuti_jadwal->users->foto_profiles->nama,
                        'nama_file' => $cuti_jadwal->users->foto_profiles->nama_file,
                        'path' => env('STORAGE_SERVER_DOMAIN') . $cuti_jadwal->users->foto_profiles->path,
                        'ext' => $cuti_jadwal->users->foto_profiles->ext,
                        'size' => $cuti_jadwal->users->foto_profiles->size,
                    ] : null,
