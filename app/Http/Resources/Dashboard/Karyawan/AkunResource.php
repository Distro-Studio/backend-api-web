    ...
    protected function formatData(Collection $collection)
    {
        return $collection->transform(function ($akun) {
            return [
                ...
                'foto_profil' => $akun->foto_profiles ? [
                    'id' => $akun->foto_profiles->id,
                    'user_id' => $akun->foto_profiles->user_id,
                    'file_id' => $akun->foto_profiles->file_id,
                    'nama' => $akun->foto_profiles->nama,
                    'nama_file' => $akun->foto_profiles->nama_file,
                    'path' => env('STORAGE_SERVER_DOMAIN') . $akun->foto_profiles->path,
                    'ext' => $akun->foto_profiles->ext,
                    'size' => $akun->foto_profiles->size,
                ] : null,
