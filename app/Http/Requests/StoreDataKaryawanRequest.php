...
class StoreDataKaryawanRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'spesialisasi_id.nullable' => 'Silahkan pilih spesialisasi karyawan terlebih dahulu.',
            'spesialisasi_id.exists' => 'Maaf spesialisasi karyawan yang dipilih tidak valid.',
