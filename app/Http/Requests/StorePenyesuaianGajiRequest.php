...
class StorePenyesuaianGajiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kategori' => 'required|in:penambah,pengurang',
    ...
    public function messages()
    {
        return [
            ...
            'kategori.in' => "Isi kategori harus berupa 'penambah' atau 'pengurang'.",
            ...
            'bulan_selesai.after_or_equal' => 'Tanggal bulan selesai harus setelah atau sama dengan bulan mulai.'
        ];
    }
