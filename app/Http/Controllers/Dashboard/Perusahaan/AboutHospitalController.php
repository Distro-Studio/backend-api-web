        ...
        try {
            ...
            $formattedData = [
                ...
                'edited_by' => $hospital->user_edited ? [
                    ...
                    'foto_profil' => $hospital->user_edited->foto_profiles ? [
                        'id' => $hospital->user_edited->foto_profiles->id,
                        'user_id' => $hospital->user_edited->foto_profiles->user_id,
                        'file_id' => $hospital->user_edited->foto_profiles->file_id,
                        'nama' => $hospital->user_edited->foto_profiles->nama,
                        'nama_file' => $hospital->user_edited->foto_profiles->nama_file,
                        'path' => $baseUrl . $hospital->user_edited->foto_profiles->path,
                        'ext' => $hospital->user_edited->foto_profiles->ext,
                        'size' => $hospital->user_edited->foto_profiles->size,
                    ] : null,
