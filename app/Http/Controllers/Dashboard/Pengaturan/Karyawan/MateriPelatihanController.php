            ...
            $formattedData = $data_pelatihan->map(function ($pelatihan) use ($baseUrl) {
                return [
                    ...
                    'user' =>  [
                        ...
                        'foto_profil' => $pelatihan->created_users->foto_profiles ? [
                            'id' => $pelatihan->created_users->foto_profiles->id,
                            'user_id' => $pelatihan->created_users->foto_profiles->user_id,
                            'file_id' => $pelatihan->created_users->foto_profiles->file_id,
                            'nama' => $pelatihan->created_users->foto_profiles->nama,
                            'nama_file' => $pelatihan->created_users->foto_profiles->nama_file,
                            'path' => $baseUrl . $pelatihan->created_users->foto_profiles->path,
                            'ext' => $pelatihan->created_users->foto_profiles->ext,
                            'size' => $pelatihan->created_users->foto_profiles->size,
                        ] : null,
        ...
        try {
            ...
            $formattedData = [
                ...
                'user' => [
                    ...
                    'foto_profil' => $data_pelatihan->created_users->foto_profiles ? [
                        'id' => $data_pelatihan->created_users->foto_profiles->id,
                        'user_id' => $data_pelatihan->created_users->foto_profiles->user_id,
                        'file_id' => $data_pelatihan->created_users->foto_profiles->file_id,
                        'nama' => $data_pelatihan->created_users->foto_profiles->nama,
                        'nama_file' => $data_pelatihan->created_users->foto_profiles->nama_file,
                        'path' => $baseUrl . $data_pelatihan->created_users->foto_profiles->path,
                        'ext' => $data_pelatihan->created_users->foto_profiles->ext,
                        'size' => $data_pelatihan->created_users->foto_profiles->size,
                    ] : null,
